...
# Generate moodle xml file (MultiChoice Reag Text)
...
f = open(xml_dir + "miss_reag_text.xml", "w")
...
for products in products_all:
    ...
    for reagents in reagents_all:
        ...
        try:
            ...
            f = open(xml_dir + "miss_reag_text.xml", "a")
            ...
            f.write('<![CDATA[<table border=\"0\">' + '<tbody>' + '<tr>' + '<td rowspan=\"3\">' + '<center>' +
                    str(reactants[0]) +
                    '</center></td>' + '<td style=\"vertical-align: bottom; height: 60px;\"><center>' + '<p style=\"font-size:200%;\">?</p>' +
